        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-200 overflow-x-hidden">
            ...
            <nav className="fixed w-full z-50 bg-gray-900/80 backdrop-blur-xl border-b border-gray-700/50 shadow-2xl">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex justify-between items-center">
                        <a href="#" className="text-2xl font-bold bg-gradient-to-r from-emerald-400 to-purple-400 bg-clip-text text-transparent relative group">
            ...
            <section id="home" ref={sectionRefs.home} className="min-h-screen flex items-center pt-24 pb-20 relative overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-emerald-400 rounded-full animate-ping"></div>
                    <div className="absolute bottom-1/3 right-1/3 w-3 h-3 bg-purple-400 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
                    <div className="absolute top-2/3 left-1/3 w-2 h-2 bg-amber-400 rounded-full animate-ping" style={{ animationDelay: '2s' }}></div>
                </div>
                ...
                <div className="container mx-auto px-6 flex flex-col-reverse lg:flex-row items-center justify-between relative z-10">
                    ...
                    <div className="lg:w-2/5 flex justify-center">
                        <div className="relative animate-float">
                            ...
                            {/* Floating elements */}
                            <div className="absolute -top-4 -right-4 w-8 h-8 bg-amber-400 rounded-full animate-bounce-slow shadow-lg"></div>
                            <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-purple-400 rounded-full animate-bounce-slow shadow-lg" style={{ animationDelay: '1.5s' }}></div>
                            <div className="absolute top-1/2 -right-8 w-6 h-6 bg-emerald-400 rounded-full animate-bounce-slow shadow-lg" style={{ animationDelay: '3s' }}></div>
                        </div>
                    </div>
                </div>
            </section>
